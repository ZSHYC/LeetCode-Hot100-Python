你好！既然你提到了“第二题”，根据你上传的《hot100(Python).pdf》中的题目顺序（按**哈希**分类），第一题是“两数之和”，那么第二题就是  **49. 字母异位词分组 (Group Anagrams)** 。

这道题是哈希表（Hash Map）应用中的经典之作，面试中非常高频。
